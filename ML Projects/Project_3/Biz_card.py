...
if selected == "Contact":
    name = "SHAIK ARSHAD ANSARI"
    mail = (f'{"Mail :"}  {"arshadshaik396@gmail.com"}')
    description = "An Aspiring ML-Engineer..!"
    social_media = {
        "GITHUB": "https://github.com/Arshad396",
        "LINKEDIN": "https://www.linkedin.com/in/shaik-arshad-ansari-96952a24a/"}
    ...
    with col2:
        ...
        st.write("BizCardX streamlines contact info from business cards, ideal for professionals managing multiple contacts.")
        st.write("---")
        st.subheader(mail)
    st.write("#")
